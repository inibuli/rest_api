...
void editData(){
var url = Uri.parse('http://localhost/restapi/update.php'); //update api calling
...
@override
void initState() {
title = TextEditingController(text: widget.list[widget.index]['title']); //setting up theexisting values in textediting control
